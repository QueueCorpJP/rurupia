              ...
              <div className="flex flex-col items-center">
                <div className="relative mb-4">
                  <div className="h-24 w-24 rounded-full overflow-hidden bg-gray-100 mb-2 border-4 border-white shadow">
                    {profile.avatar_url ? ( // Using correct property name
                      <img 
                  ...
                  {profile.is_verified && ( // Using correct property name
          ...
          <div className="md:col-span-2">
            ...
            <div className="mb-8 bg-gray-50 p-6 rounded-lg border">
              <div className="flex justify-between items-center mb-4">
                ...
                <Badge variant={profile.is_verified ? "success" : "outline"}> {/* Using correct property name */}
                  {profile.is_verified ? "認証済み" : "未認証"} {/* Using correct property name */}
                </Badge>
              </div>
